// Package mail implements kind 15 NOSTR Mail event creation and parsing.
//
// A kind 15 event is a "rumor" — an unsigned event that carries structured
...
// Rumor represents an unsigned kind 15 mail event.
...
// CreateParams holds all parameters needed to construct a kind 15 mail rumor.
...
// ParsedMail is the structured representation extracted from a kind 15 rumor.
...
// CreateRumor builds a kind 15 mail rumor from the given parameters.
...
// ParseRumor extracts structured data from a kind 15 rumor.
